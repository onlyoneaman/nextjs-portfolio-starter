...
export const FollowPointer = ({
  ...
  return (
    ...
    >
      ...
      >
        {title || techFamousPeople[Math.floor(Math.random() * techFamousPeople.length)]}
      </motion.div>
    </motion.div>
  );
};
